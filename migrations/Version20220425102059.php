 ...
 */
final class Version20220425102059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chambre ADD type VARCHAR(255) NOT NULL, CHANGE id_hotel id_hotel INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE likee DROP FOREIGN KEY fk_voiture');
        $this->addSql('ALTER TABLE likee DROP FOREIGN KEY fk_user');
        $this->addSql('DROP INDEX id_voiture ON likee');
        $this->addSql('ALTER TABLE likee CHANGE id_user id_user INT DEFAULT NULL, CHANGE id_commentaire id_commentaire INT DEFAULT NULL, CHANGE id_voiture voiture_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE likee ADD CONSTRAINT FK_BD1EFB2C181A8BA FOREIGN KEY (voiture_id) REFERENCES voiture (id)');
        $this->addSql('CREATE INDEX IDX_BD1EFB2C181A8BA ON likee (voiture_id)');
        ...
        $this->addSql('ALTER TABLE sujet CHANGE iduser iduser INT DEFAULT NULL, CHANGE idtopic idtopic INT DEFAULT NULL, CHANGE accepter accepter INT NOT NULL, CHANGE nbcom nbcom INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie CHANGE libelle libelle VARCHAR(30) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE description description VARCHAR(100) NOT NULL COLLATE `utf8mb4_general_ci`');
        $this->addSql('ALTER TABLE chambre DROP FOREIGN KEY FK_C509E4FFEDD61FE9');
        $this->addSql('ALTER TABLE chambre DROP type, CHANGE id_hotel id_hotel INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE likee DROP FOREIGN KEY FK_BD1EFB2C181A8BA');
        $this->addSql('DROP INDEX IDX_BD1EFB2C181A8BA ON likee');
        $this->addSql('ALTER TABLE likee CHANGE id_user id_user INT NOT NULL, CHANGE id_commentaire id_commentaire INT NOT NULL, CHANGE voiture_id id_voiture INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE likee ADD CONSTRAINT fk_voiture FOREIGN KEY (id_voiture) REFERENCES voiture (id)');
        ...
        $this->addSql('CREATE INDEX id_voiture ON likee (id_voiture)');
