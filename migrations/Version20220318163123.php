...
final class Version20220318163123 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chambre CHANGE id_hotel id_hotel INT NOT NULL, CHANGE type type VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`');
        ...
        $this->addSql('ALTER TABLE hotel CHANGE adresse adresse VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE ville ville VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE region region VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE description description TEXT NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE libelle libelle VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE image image VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_general_ci`');
        ...
        $this->addSql('ALTER TABLE likee CHANGE id_user id_user INT NOT NULL, CHANGE id_commentaire id_commentaire INT NOT NULL');
