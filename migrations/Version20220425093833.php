 ...
 */
final class Version20220425093833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE likee CHANGE id_user id_user INT DEFAULT NULL, CHANGE id_commentaire id_commentaire INT DEFAULT NULL, CHANGE voiture voiture_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE likee CHANGE id_user id_user INT NOT NULL, CHANGE id_commentaire id_commentaire INT NOT NULL, CHANGE voiture_id voiture INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE likee ADD CONSTRAINT fk_voiture FOREIGN KEY (voiture) REFERENCES voiture (id)');
        ...
        $this->addSql('CREATE INDEX id_voiture ON likee (voiture)');
