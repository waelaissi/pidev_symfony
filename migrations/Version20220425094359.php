 ...
 */
final class Version20220425094359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE likee ADD voiture_id INT DEFAULT NULL, CHANGE id_user id_user INT DEFAULT NULL, CHANGE id_commentaire id_commentaire INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE likee DROP voiture_id, CHANGE id_user id_user INT NOT NULL, CHANGE id_commentaire id_commentaire INT NOT NULL');
