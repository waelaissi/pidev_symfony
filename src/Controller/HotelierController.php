...
{
    /**
     * @Route("/", name="dashboardhotelier")
     */
    public function index(): Response
    {
        return $this->render('hotelier/index.html.twig', [
            'controller_name' => 'HotelierController',
        ]);
    }

    /**
     * @return Response
     * @Route("/info",name="infopersonnelhotelier")
     */
    public function information()
    {
        return $this->render('hotelier/information_personnel_hotelier.html.twig');
    }
     ...
     * @Route("/updatehotelier/{id}",name="hotelierUpdate")
     */
    public function update($id, UtilisateurRepository $repository, Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($file == null){
                ...
                return $this->redirectToRoute('infopersonnelhotelier');
            }
            if( $file  ){
        ...
        return $this->render('hotelier/modifier_profile_hotelier.html.twig', [
     ...
     * @return \Symfony\Component\HttpFoundation\RedirectResponse|Response
     * @Route("/resetpass",name="resetpasswordhotelier")
     */
    public function changerPassword(Request $request, UserPasswordEncoderInterface $passwordEncoder)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($passwordEncoder->isPasswordValid($user, $oldPassword)) {
                ...
                return $this->redirectToRoute('dashboardhotelier');
            } else {
        ...
        return $this->render('hotelier/passwordChangeHotelier.html.twig', array(
            'form' => $form->createView(),
        ));
    }
